<%-- 
    Document   : 406_Becario_Sol_Acuerdo_Gestion_Liberacion
    Created on : 11-16-2016, 06:34:39 PM
    Author     : aquel
--%>
...
<body>
    ...
    <div class="container-fluid">        
            <H3 class="text-center" style="color:#E42217;">Solicitar Acuerdo de Gestión de Liberación</H3>
        <fieldset class="custom-border">
                <legend class="custom-border">Solicitar Acuerdo de Gestión de Liberación</legend>
        <div class="row">
            <div class="col-md-12">                
                <fieldset class="custom-border">
