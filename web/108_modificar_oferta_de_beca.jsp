...
<body>
    ...
    <div class="container-fluid">
        <div class="row"><!-- TITULO DE LA PANTALLA -->
            <h2>
                <p class="text-center" style="color:#cf2a27">Actualizar Oferta de Beca</p>
            </h2>
        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="AgregarUsuarioServlet" method="post">
                <fieldset class="custom-border">  
                    <legend class="custom-border">Actualizar oferta de beca</legend>
                    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <input type="submit" class="btn btn-primary" name="submit" value="Actualizar oferta">
