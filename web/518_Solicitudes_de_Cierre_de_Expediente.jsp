                                                ...
                                                <div class="col-md-12">   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">                                                                                    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.NOMBRE1.$error.minlength">Mínimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.NOMBRE1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        ...
                                                        <div class="col-md-3">    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.NOMBRE2.$error.minlength">Mínimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.NOMBRE2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.APELLIDO1.$error.minlength">Mínimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.APELLIDO1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.APELLIDO2.$error.minlength">Mínimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudCierreExpedientePendiente.APELLIDO2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div>
