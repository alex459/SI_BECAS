<%-- 
    Document   : 519_Resolver_Cierre_de_Expediente
    Created on : 25/12/2016, 09:24:16 PM
    Author     : adminPC
--%>
    ...
    <body ng-app="resolverCierreApp" ng-controller="CierreCtrl">
     <div class="container-fluid">
            ...
            <h2 class="text-center" style="color:#cf2a27">
                Resolver Solicitud de Cierre de Expediente
            </h2>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <fieldset class="custom-border">
                                                    ...
                                                    <form  name="resolverCierre" action="ResolverCierreExpediente" method="POST" novalidate>           
                                                            ...
                                                            <div class="col-md-10 btn-group text-center" data-toggle="buttons">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="btn btn-danger" ng-click="CambiarEstadoCierre()">
                                                                        <input type="radio" name="resolucion" value="CERRAR" autocomplete="off" ng-model="resolucion" ng-required="true"> Cerrar Expediente
                                                                    </label>
                                                                </div>
                                                                <div class="col-md-6">
                                                        ...
                                                        <div class="row text-center">
                                                            <span class="text-danger" ng-show="!resolverCierre.$pristine && resolverCierre.resolucion.$error.required">Debe Seleccionar una Resolucion.</span>
                                                        </div> 
                                                        <div class="row text-center">
                                                            <br>
                                                        </div>
                                                        <div class="row text-center">
                                                            <input type="hidden" name="id_documento" value="<%=id_documento%>">
                                                            <input type="submit" value="Guardar" class="btn btn-success" ng-disabled="!resolverCierre.$valid">
                                                        </div>  
                                                    </form>    
                                                </fieldset>
                                            </div>
...
<script src="js/resolverCierre.js"></script>
