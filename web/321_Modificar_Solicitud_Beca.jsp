...
<%
   ...
   //Obteniendo documentos adjuntos 
   String listaDocumentos="";
try{
    DocumentoDAO documentoDao = new DocumentoDAO();
    ArrayList<Documento> lista = documentoDao.documentosDictamenPropuesta(expediente.getIdExpediente());
    Gson gson3 = new Gson();
    String listaJSON1 = gson3.toJson(lista);
    listaDocumentos = listaJSON1.replace("\"", "'");
}catch(Exception e){
    e.printStackTrace();
}
...
<html>
    ...
    <script src="js/EditarSolicitudBeca.js"></script>
