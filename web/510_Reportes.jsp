...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <a href="">Reporte de Becarios por Institucion Financiera</a><br><br>
                <a href="">Reporte de Becarios con Incumplimiento de Contrato</a><br><br>
                <a href="">Reporte de Candidatos a Beca</a><br><br>
                <a href="">Reporte de Becarios con Documentos Pendientes</a><br><br>
                <a href="">Reporte de Instituciones con Becarios Activos</a><br><br>
                <a href="">Reporte por Tipos de Becarios </a><br><br>
                <a href="">Reporte de Documentos Emitidos por Unidad</a><br><br>
            </div>
        </div>
