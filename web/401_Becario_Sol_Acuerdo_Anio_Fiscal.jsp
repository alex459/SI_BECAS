        ...
        <div class="container-fluid">
            <div class="row"><!-- TITULO DE LA PANTALLA -->
                <h2 class="text-center" style="color:#cf2a27">
                    Solicitar Acuerdo de Año Fiscal
                </h2>
                <br></br> 
            ...
            <div class="col-md-12"><!-- CONTENIDO DE LA PANTALLA -->       
                <fieldset class="custom-border">
                    ...
                    <%if(expediente.getIdProgreso() == 9 || expediente.getIdProgreso() == 10){%>
                        ...
                        <%}else{%>
                            <form name="solicitarLiberacion" class="form-horizontal" action="SolAcuerdoAnioFiscalServlet" method="post" enctype="multipart/form-data">
                                <div class="col-md-8 col-md-offset-2 row">
                                    <div class="row">
                                        <div class="col-md-5">
                                            Carta de solicitud de Acuerdo:
                                        </div>
                                        <div class="col-md-7">
