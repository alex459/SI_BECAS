<%-- 
    Document   : 403_Becario_Agregar_Documento_Finalizacion_Beca
    Created on : 11-16-2016, 05:22:22 PM
    Author     : aquel
--%>
...
<body>
    ...
    <div class="container-fluid">        
            <H3 class="text-center" style="color:#E42217;">Agregar Documentos Finalizacion de Beca</H3>
        <fieldset class="custom-border">
                <legend class="custom-border">Agregar Documentos Finalizacion de Beca</legend>
        <div class="row">
            <div class="col-md-12">                
                <fieldset class="custom-border">
                                    ...
                                    <div class="col-md-4 col-md-offset-1">
                                        <div class="form-group">
                                            <select id="facultad" name="tipoDoc" class="form-control">
                                                ...
                                                <option value="2">Certificación de notas</option>
                                                <option value="2">Acta de evaluación de tesis</option>
