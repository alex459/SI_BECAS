<%-- 
    Document   : 413_Consejo_Superior_Universitario_Solicitud_Acuerdos_Pendientes
            ...
            <div class="col-md-12"><!-- CONTENIDO DE LA PANTALLA -->
                    ...
                    <fieldset class="custom-border">
                        <legend class="custom-border">Solicitudes de Acuerdos Pendientes</legend>
                         ...
                         <form name="solicitudAcuerdosPendientesConsejoSuperiorUniversitario" class="form-horizontal" action="413_Consejo_Superior_Universitario_Solicitud_Acuerdos_Pendientes.jsp" method="post" novalidate>
                                        ...
                                        <legend class="custom-border">Filtros</legend>
                                                ...
                                                <div class="col-md-12">   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">                                                                                    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.NOMBRE1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.NOMBRE1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        ...
                                                        <div class="col-md-3">    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.NOMBRE2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.NOMBRE2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.APELLIDO1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.APELLIDO1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.APELLIDO2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.APELLIDO2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">   
                                                    ...
                                                    <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.CARNET.$error.minlength">Mínimo 7 Caracteres.</span>
                                                    <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoSuperiorUniversitario.CARNET.$error.pattern">Solo se Permiten Letras Mayúsculas y Números. (A-Z, 0-9).</span>
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        if(rs.getString(10).equals("PENDIENTE")){
                                            out.write("<form style='display:inline;' action='414_Consejo_Superior_Universitario_Resolver_Solicitud.jsp' method='post'><input type='hidden' name='ID_DOCUMENTO' value='" + rs.getString(9) + "'><input type='hidden' name='ACCION' value='insertar'><input type='submit' class='btn btn-success' name='submit' value='Resolver'></form> ");
                                        }else{
                                            out.write("<form style='display:inline;' action='414_Consejo_Superior_Universitario_Resolver_Solicitud.jsp' method='post'><input type='hidden' name='ID_DOCUMENTO' value='" + rs.getString(9) + "'><input type='hidden' name='ACCION' value='actualizar'><input type='hidden' name='idTipoDocumento' value='" + rs.getString(11) + "'><input type='submit' class='btn btn-success' name='submit' value='Resolver'></form> ");
                                        }
