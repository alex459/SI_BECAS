        ...
        <div class="row">            
            <div class="col-md-2">
                <ul id="sidebar" class="nav nav-pills nav-stacked" style="max-width: 200px;">
                    ...
                    <li class="active"><a href="312_candidato_sol_beca5.jsp">Información de beca</a></li>
                    ...
                    <form class="form-horizontal">
                        ...
                        <form>
                            <div class="row no-gutter">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" id="labeltitulo" value="Titulo a obtener:" disabled style="font-weight: bold; background-color:#728FCE; color:white">    
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="row no-gutter">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" id="labeltipo" value="Tipo de beca:" disabled style="font-weight: bold;background-color:#728FCE; color:white">    
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="row no-gutter">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" id="labelBecaAnt" value="Becas anteriores:" disabled style="font-weight: bold;background-color:#728FCE; color:white">    
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="becasAnt" disabled>    
                                    </div>
                                </div>
                            </div>  
                        </form></div>
                            ...
                            <div class="row">
                                <div class="col-md-12">     
                                    <label for="textinput">Beneficios que espera obtener:</label>
                                    <textarea class="form-control" id="textarea" name="textarea"></textarea>
                                </div>
                            </div></br>              
                             <div class="row">
                                 <div class="col-md-2">     
                                    <label for="textinput">Semestre</label>
