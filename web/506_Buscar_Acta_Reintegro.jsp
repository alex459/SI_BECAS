                            ...
                            <table class="table text-center">
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        out.write("<form style='display:inline;' action='504_Resolver_Solicitudes_Reintegro_Beca.jsp' method='post'><input type='hidden' name='ID_EXPEDIENTE' value='" + rs.getString(9) + "'><input type='submit' class='btn btn-danger' name='submit' value='Resolver'></form> ");
