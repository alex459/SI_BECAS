                                        ...
                                        <legend class="custom-border">Filtros</legend>
                                                ...
                                                <div class="col-md-12">   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">                                                                                    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.NOMBRE1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.NOMBRE1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        ...
                                                        <div class="col-md-3">    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.NOMBRE2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.NOMBRE2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.APELLIDO1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.APELLIDO1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.APELLIDO2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.APELLIDO2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">   
                                                    ...
                                                    <span class="text-danger" ng-show="solicitudReintegroBeca.CARNET.$error.minlength">Mínimo 7 Caracteres.</span>
                                                    <span class="text-danger" ng-show="solicitudReintegroBeca.CARNET.$error.pattern">Solo se Permiten Letras Mayúsculas y Números. (A-Z, 0-9).</span>
                                                ...
                                                <div class="col-md-6">   
                                                    <label for="textinput">Expediente :</label>  
                                                         <input id="ID_EXPEDIENTE" name="ID_EXPEDIENTE" type="text" placeholder="Ingrese Número de Expediente a Buscar" class="form-control input-md" ng-model="datos.idexpediente" ng-pattern="/^[0-9]*$/" minlength="1" maxlength="4">
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.ID_EXPEDIENTE.$error.minlength">Mínimo 1 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudReintegroBeca.ID_EXPEDIENTE.$error.pattern">Solo se Permiten Números. (0-9).</span>
