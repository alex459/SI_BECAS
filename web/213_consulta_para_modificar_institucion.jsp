                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <fieldset class="custom-border">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="text_NomInstitucion" name="text_NomInstitucion" type="text" placeholder="Ingrese el Nombre de Institución" class="form-control input-md" ng-model="datos.nombreInst"  ng-pattern="/^[A-ZÁÉÍÓÚÑ ]*$/" minlength="3" maxlength="100" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tex_paisInstitucion" name="tex_paisInstitucion" type="text" placeholder="Ingrese el País" class="form-control input-md" ng-model="datos.pais"  ng-pattern="/^[A-ZÁÉÍÓÚÑ ]*$/" minlength="3" maxlength="20" >

                                        <span class="text-danger" ng-show="consultaParaModificarInstitucion.tex_paisInstitucion.$error.minlength">Mínimo 3 Caracteres</span>
                                        <span class="text-danger" ng-show="consultaParaModificarInstitucion.tex_paisInstitucion.$error.pattern">Solo se Permiten Letras Mayúsculas (A-Z).</span>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
