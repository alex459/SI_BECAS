        ...
        <div class="container-fluid" >
            ...
            <%
                ...
                try {
                    ...
                    consultaSql = "SELECT NOMBRE_INSTITUCION, TIPO_INSTITUCION, PAIS, PAGINA_WEB, EMAIL, ID_INSTITUCION  FROM  INSTITUCION WHERE NOMBRE_INSTITUCION LIKE '%"+nombre+"%' AND PAIS LIKE '%"+pais+"%' AND TIPO_INSTITUCION LIKE '%"+tipo+"%' AND INSTITUCION_ACTIVA LIKE '%1%'";
                        ...
                        <%
                            try {
                                ...
                                while (rs.next()) {
                                    ...
                                    out.write("<td>");
                                    out.write("<center>");
                                    out.write("<form style='display:inline;' action='205_modificar_institucion.jsp' method='post'><input type='hidden' name='ID_INSTITUCION' value='" + rs.getString(6) + "'><input type='submit' class='btn btn-success' name='submit' value='Mostrar institución'></form> ");
                                    out.write("</center>");
                                    out.write("</td>");
                                    out.write("</tr>");
                                }
