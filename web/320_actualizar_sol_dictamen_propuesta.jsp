...
<% 
    ...
    int idexp = Integer.parseInt(request.getParameter("idexp").toString()); 
                ...
                try {
                    ...
                    String consultaSql = "";
                    consultaSql = "SELECT ID_DOCUMENTO FROM DOCUMENTO WHERE ID_EXPEDIENTE="+idexp+" AND ID_TIPO_DOCUMENTO=106;";
...
<body ng-app = "solicitudApp" ng-controller="SolicitarDictamenCtrl">
    ...
    <div class="container-fluid">        
        ...
        <fieldset class="custom-border">
                <legend class="custom-border">Actualizar solicitud de dictamen de propuesta</legend>
        <div class="row">
            <div class="col-md-12">                
                <fieldset class="custom-border">
                    <legend class="custom-border">Adjuntar documentación necesaria</legend>
                            <form name="solicitudDictamen" action="ActualizarDictamenPropuestaServlet" method="post" enctype="multipart/form-data">
                                <div class="row"> 
