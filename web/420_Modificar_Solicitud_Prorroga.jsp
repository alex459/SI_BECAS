<%-- 
    Document   : 420_Modificar_Solicitud_Prorroga
    Created on : 9/01/2017, 02:12:01 PM
    Author     : adminPC
--%>
...
<%
    ...
    ArrayList<Documento> lista = documentoDao.documentosProrrogaJD(idexp);
    int numero = 1;
...
<html>
    ...
    <body ng-app = "solicitudApp" ng-controller="SolicitarAutorizacionCtrl">
        ...
        <div class="container-fluid">        
            <H3 class="text-center" style="color:#E42217;">Editar Solicitud de Prorroga</H3>
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-10">
                    <fieldset class="custom-border">
                        <legend class="custom-border">Solicitud de Prorroga</legend>
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <fieldset class="custom-border">
                    ...
                    <form name="solicitudPermisoInicial" action="ActualizarSolicitudProrrogaServlet" method="post" enctype="multipart/form-data" novalidate>
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-control-static"> Carta de Solicitud de Prórroga para Junta Directiva:</label>
                                        </div>   
                                        <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-control-static"> Carta de Solicitud de Prórroga para el Consejo de Becas:</label>
                                        </div>   
                                        <div class="col-md-6">
                                            <label class="radio-inline" for="radios-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-control-static"> Constancia de la Institución:</label>
                                        </div>   
                                        <div class="col-md-6">
                                            <label class="radio-inline" for="radios-0">
