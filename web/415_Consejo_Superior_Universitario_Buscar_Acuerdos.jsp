       ...
       <ul class="nav navbar-nav">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="413_Consejo_Superior_Universitario_Solicitud_Acuerdos_Pendientes.jsp">Solicitudes de Acuerdos Pendientes</a>
                        <a href="414_Consejo_Superior_Universitario_Resolver_Solicitud.jsp">Resolver Solicitud de Acuerdo Pendiente</a>
                        <a href="415_Consejo_Superior_Universitario_Buscar_Acuerdos.jsp">Buscar Acuerdo</a>
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <label>Fecha de Resolucion:</label><input type="text" class="form-control" name="fecha_resolucion"><br>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <input type="button" name="ver" value="Ver" class="btn btn-success">
                                            <input type="button" name="editar" value="Editar" class="btn btn-danger">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
