<%-- 
    Document   : 509_Consejo_Becas_Buscar_Acuerdo
    ...
    <div class="container-fluid">
        ...
        <fieldset class="custom-border">
                <legend class="custom-border">Solicitudes de Acuerdos Pendientes</legend>
                    <form name="solicitudAcuerdosPendientesConsejoBecas" class="form-horizontal" action="509_Consejo_Becas_Buscar_Acuerdo.jsp" method="post" novalidate>
