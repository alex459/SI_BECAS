        ...
        <div class="col-md-12">            
            <fieldset class="custom-border">  
                ...
                <div class="row">   <!-- FILTROS -->
                    ...
                    <div class="col-md-12">
                        <form name= "consultarUsuario" class="form-horizontal" action="113_consulta_para_dar_de_baja_usuario.jsp" method="post" novalidate>
                            <fieldset class="custom-border">  
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <span class="text-danger" ng-show="consultarUsuario.CARNET.$error.pattern">Solo se Permiten Letras Mayúsculas, Números y Punto(.).</span>
                                    </div>
                                    <div class="col-md-1 text-right">
