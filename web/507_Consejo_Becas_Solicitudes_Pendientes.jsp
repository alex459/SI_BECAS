<%-- 
    Document   : 507_Consejo_Becas_Solicitudes_Pendientes
    Created on : 29/10/2016, 10:35:53 PM
    Author     : adminPC
--%>
...
<body ng-app="solicitudAcuerdosPendientesConsejoBecasApp" ng-controller="solicitudAcuerdosPendientesConsejoBecasCtrl">
        <div class="container-fluid" >
                                        ...
                                        <legend class="custom-border">Filtros</legend>
                                                ...
                                                <div class="col-md-12">   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">                                                                                    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        ...
                                                        <div class="col-md-3">    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO1.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO1.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO2.$error.minlength">Mínimo 3 Caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO2.$error.pattern">Solo se Permiten Letras Mayúsculas. (A-Z).</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">   
                                                    ...
                                                    <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.CARNET.$error.minlength">Mínimo 7 Caracteres.</span>
                                                    <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.CARNET.$error.pattern">Solo se Permiten Letras Mayúsculas y Números. (A-Z, 0-9).</span>
                                                    ...
                                                    <label for="textinput">Tipo de Documento :</label>  
                                                         <select id="selectbasic" name="ID_TIPO_DOCUMENTO" class="form-control">
                                                                ...
                                                                <%
                                                                    ...
                                                                    listaTipoDocumento = tipoDocumentoDao.consultarPorDepartamento("CONSEJO DE BECAS");
                                       ...
                                       <div class="col-md-6">          
                                        ...
                                        <div class="col-md-6">      
                                            ...
                                            <div class="row text-center"> 
                                                <input type="submit" class="btn btn-primary" name="submit" value="Buscar" ng-disabled="!solicitudAcuerdosPendientesConsejoBecas.$valid">
                                            </div>
                                        </fieldset>
           ...
           <%
            ...
            String consejoB= "CONSEJO DE BECAS";
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        if(rs.getString(10).equals("PENDIENTE")){
                                            out.write("<form style='display:inline;' action='508_Consejo_Becas_Resolver_Solicitud.jsp' method='post'><input type='hidden' name='ID_DOCUMENTO' value='" + rs.getString(9) + "'><input type='hidden' name='ACCION' value='insertar'><input type='submit' class='btn btn-success' name='submit' value='Resolver'></form> ");
                                        }else{
                                            out.write("<form style='display:inline;' action='508_Consejo_Becas_Resolver_Solicitud.jsp' method='post'><input type='hidden' name='ID_DOCUMENTO' value='" + rs.getString(9) + "'><input type='hidden' name='ACCION' value='actualizar'><input type='submit' class='btn btn-success' name='submit' value='Resolver'></form> ");
                                        }                                        
