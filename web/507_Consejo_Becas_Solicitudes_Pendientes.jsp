                                                ...
                                                <div class="col-md-12">   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">                                                                                    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE1.$error.minlength">Minimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE1.$error.pattern">Solo se permiten letras mayusculas. (A-Z).</span>
                                                        ...
                                                        <div class="col-md-3">    
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE2.$error.minlength">Minimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.NOMBRE2.$error.pattern">Solo se permiten letras mayusculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO1.$error.minlength">Minimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO1.$error.pattern">Solo se permiten letras mayusculas. (A-Z).</span>
                                                        </div> 
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO2.$error.minlength">Minimo 3 caracteres.</span>
                                                            <span class="text-danger" ng-show="solicitudAcuerdosPendientesConsejoBecas.APELLIDO2.$error.pattern">Solo se permiten letras mayusculas. (A-Z).</span>
                                                        </div>
