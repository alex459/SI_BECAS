<%-- 
    Document   : 118_Modificar_Becario_Consulta
    Created on : 6/03/2017, 09:03:15 AM
    Author     : adminPC
--%>
...
<body ng-app="consultarUsuarioApp" ng-controller="consultarUsuarioCtrl">
    ...
    <div class="container-fluid">
        <div class="row"><!-- TITULO DE LA PANTALLA -->
            <h3>
                <p class="text-center" style="color:#cf2a27">Modificar Becario</p>
            </h3>
        ...
        <div class="col-md-12">            
            <fieldset class="custom-border">  
                <legend class="custom-border">Paso 1: Buscar Usuario</legend> 
                ...
                <div class="row">   <!-- FILTROS -->
                    ...
                    <div class="col-md-12">
                        ...
                        <form name= "consultarUsuario" class="form-horizontal" action="118_Modificar_Becario_Consulta.jsp" method="post" novalidate>
                            <fieldset class="custom-border">  
            ...
            <%
                ...
                try {
                    ...
                    String consultaSql;                    
                    consultaSql = "SELECT DU.NOMBRE1_DU, DU.NOMBRE2_DU, DU.APELLIDO1_DU, DU.APELLIDO2_DU, DU.CARNET, F.FACULTAD, OB.NOMBRE_OFERTA, U.ID_USUARIO, E.ID_EXPEDIENTE ,B.FECHA_INICIO, B.FECHA_FIN FROM DETALLE_USUARIO DU JOIN USUARIO U ON DU.ID_USUARIO = U.ID_USUARIO JOIN FACULTAD F ON DU.ID_FACULTAD = F.ID_FACULTAD JOIN SOLICITUD_DE_BECA SB ON SB.ID_USUARIO = U.ID_USUARIO JOIN EXPEDIENTE E ON E.ID_EXPEDIENTE = SB.ID_EXPEDIENTE JOIN DOCUMENTO D ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE JOIN OFERTA_BECA OB ON SB.ID_OFERTA_BECA = OB.ID_OFERTA_BECA JOIN BECA B ON B.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE D.OBSERVACION_O = 'DOCUMENTO DE BECARIO AGREGADO AL SISTEMA MANUALMENTE' AND DU.NOMBRE1_DU LIKE '%" + nombre1 + "%' AND DU.NOMBRE2_DU LIKE '%" + nombre2 + "%' AND DU.APELLIDO1_DU LIKE '%" + apellido1 + "%' AND DU.APELLIDO2_DU LIKE '%" + apellido2 + "%' AND DU.CARNET LIKE '%" + carnet + "%'  ";
                    ...
                    consultaSql = consultaSql.concat(" GROUP BY E.ID_EXPEDIENTE");
