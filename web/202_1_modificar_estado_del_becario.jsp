<%-- 
    Document   : 202_1_datos_del_becario_a_modificar
    Created on : 11-15-2016, 04:29:35 AM
...
<html>
    ...
    <body ng-app="ActualizarEstadoBecarioApp" ng-controller="ActualizarEstadoBecarioCtrl">
