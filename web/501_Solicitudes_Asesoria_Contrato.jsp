...
<body ng-app="solicitudAsesoriaContratoApp" ng-controller="solicitudAsesoriaContratoCtrl">
        <div class="container-fluid" >
            <div class="row"><!-- TITULO DE LA PANTALLA -->
                <h2>
                    <p class="text-center" style="color:#cf2a27">Solicitudes de Asesorías de Contrato de Beca</p>
                </h2>
                <br></br> 
            ...
            <div class="col-md-12"><!-- CONTENIDO DE LA PANTALLA -->
                    ...
                    <fieldset class="custom-border">
                        <legend class="custom-border">Solicitudes de Contratos Pendientes</legend>
                            ...
                            <table  id="tablaResultados" class="table table-bordered">
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        out.write("<td>");
                                        out.write("<center>");
                                        out.write("<form style='display:inline;' action='502_Resolver_Solicitudes_Asesoria_Contrato.jsp' method='post'><input type='hidden' name='ID_EXPEDIENTE' value='" + rs.getString(9) + "'><input type='submit' class='btn btn-success' name='submit' value='Resolver'></form> ");
