<%-- 
    Document   : Agregar_Becario_Consulta
        ...
        <div class="col-md-12">            
            <fieldset class="custom-border">  
                ...
                <div class="row">   <!-- FILTROS -->
                    ...
                    <div class="col-md-12">
                        ...
                        <form name= "consultarUsuario" class="form-horizontal" action="Agregar_Becario_Consulta.jsp" method="post" novalidate>
                            <fieldset class="custom-border">  
            ...
            <%
                ...
                try {
                    ...
                    consultaSql = "SELECT DU.NOMBRE1_DU, DU.NOMBRE2_DU, DU.APELLIDO1_DU, DU.APELLIDO2_DU, DU.CARNET, F.FACULTAD, TU.TIPO_USUARIO, U.ID_USUARIO, DU.ID_DETALLE_USUARIO  FROM DETALLE_USUARIO DU NATURAL JOIN USUARIO U NATURAL JOIN FACULTAD F NATURAL JOIN TIPO_USUARIO TU WHERE TU.TIPO_USUARIO NOT IN ('BECARIO', 'ADMINISTRADOR DEL SISTEMA') AND DU.NOMBRE1_DU LIKE '%" + nombre1 + "%' AND DU.NOMBRE2_DU LIKE '%" + nombre2 + "%' AND DU.APELLIDO1_DU LIKE '%" + apellido1 + "%' AND DU.APELLIDO2_DU LIKE '%" + apellido2 + "%' AND DU.CARNET LIKE '%" + carnet + "%'";
                ...
                <div class="col-md-12">
                    ...
                    <table id="tablaUsuarios" class="table table-bordered text-center"></br>                        
                        ...
                        <div class="row text-center">
                            <a href="101_agregar_usuario.jsp" class="btn btn-success">Agregar Usuario</a>
                        </div>
                </div>
