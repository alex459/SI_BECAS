 ...
 * @author alex
 */
@WebServlet("/ReporteInstitucionBecariosActivosServlet")
public class ReporteInstitucionBecariosActivosServlet extends HttpServlet {
          ...
          parametersMap.put("condicion", condicion);
            ...
            /*
                ...
                */
                ...
                byte[] bytes = JasperRunManager.runReportToPdf(path + "/515_Reporte_Institucion_becarios_Activos.jasper", parametersMap, conexionBD.conn);
                conexionBD.cerrarConexion();
                response.setContentType("application/pdf");
                response.setContentLength(bytes.length);
                ServletOutputStream outputstream = response.getOutputStream();
