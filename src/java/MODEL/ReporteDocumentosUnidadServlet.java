 ...
 * @author alex
 */
@WebServlet("/ReporteDocumentosUnidadServlet")
public class ReporteDocumentosUnidadServlet extends HttpServlet {
          ...
          parametersMap.put("condicion", condicion);
            ...
            /*
                ...
                */
                ...
                byte[] bytes = JasperRunManager.runReportToPdf(path + "/517_Reporte_Documentos_Unidad.jasper", parametersMap, conexionBD.conn);
                conexionBD.cerrarConexion();
                response.setContentType("application/pdf");
                response.setContentLength(bytes.length);
                ServletOutputStream outputstream = response.getOutputStream();
