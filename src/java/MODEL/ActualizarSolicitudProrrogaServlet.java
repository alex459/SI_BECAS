 ...
 * @author adminPC
 */
@WebServlet(name = "ActualizarSolicitudProrrogaServlet", urlPatterns = {"/ActualizarSolicitudProrrogaServlet"})
@MultipartConfig(maxFileSize = 16177215)
public class ActualizarSolicitudProrrogaServlet extends HttpServlet {
        ...
        try {
            ...
            switch (accCarta) {
                ...
                case "eliminar":
                    ...
                    id_documento = documentoDao.ExisteDocumento(idExpediente, 114);
                    if (id_documento != 0) {
                        //eliminar
            ...
            switch (accCartaEscuela) {
                ...
                case "eliminar":
                    //Obteniendo el id del documento
                    id_documento = documentoDao.ExisteDocumento(idExpediente, 113);
                    if (id_documento != 0) {
                        //eliminar
                        documentoDao.eliminarDocumento(id_documento);
                    } else {
            ...
            switch (accCartaInstitucion) {
                ...
                case "eliminar":
                    //Obteniendo el id del documento
                    id_documento = documentoDao.ExisteDocumento(idExpediente, 115);
                    if (id_documento != 0) {
                        //eliminar
                        documentoDao.eliminarDocumento(id_documento);
                    } else {
            ...
            if(accCarta.equals("ninguna") && accCartaEscuela.equals("ninguna") && accCartaInstitucion.equals("ninguna")){
                ...
                id_documento = documentoDao.ExisteDocumento(idExpediente, 140);
                documento = documentoDao.obtenerInformacionDocumentoPorId(id_documento);
