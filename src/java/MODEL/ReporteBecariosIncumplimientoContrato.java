 ...
 * @author next
 */
@WebServlet("/ReporteBecariosIncumplimientoContrato")
public class ReporteBecariosIncumplimientoContrato extends HttpServlet {
          ...
          parametersMap.put("condicion", condicion);
            ...
            /*
                ...
                */
                ...
                byte[] bytes = JasperRunManager.runReportToPdf(path + "/512_Reporte_Becarios_Incumplimiento_Contrato.jasper", parametersMap, conexionBD.conn);
                conexionBD.cerrarConexion();
                response.setContentType("application/pdf");
                response.setContentLength(bytes.length);
                ServletOutputStream outputstream = response.getOutputStream();
