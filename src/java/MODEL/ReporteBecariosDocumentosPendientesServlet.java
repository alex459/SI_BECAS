 ...
 * @author alex
 */
@WebServlet("/ReporteBecariosDocumentosPendientesServlet")
public class ReporteBecariosDocumentosPendientesServlet extends HttpServlet {
          ...
          parametersMap.put("condicion", condicion);
            ...
            /*
                ...
                */
                ...
                byte[] bytes = JasperRunManager.runReportToPdf(path + "/514_Reporte_Becarios_Documentos_Pendientes.jasper", parametersMap, conexionBD.conn);
                conexionBD.cerrarConexion();
                response.setContentType("application/pdf");
                response.setContentLength(bytes.length);
                ServletOutputStream outputstream = response.getOutputStream();
