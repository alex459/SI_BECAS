...
@WebServlet(name = "loginLDAPNuevoServlet", urlPatterns = {"/loginLDAPNuevoServlet"})
public class loginLDAPNuevoServlet extends HttpServlet {
    ...
    public DirContext loginLDAP(String userName, String passWord) {
        ...
        DirContext ctx = null;
        try {
            String principal = "uid=" + userName + ",dc=example,dc=com";
            Hashtable<String, String> env = new Hashtable<String, String>();
            env.put(Context.INITIAL_CONTEXT_FACTORY, "com.sun.jndi.ldap.LdapCtxFactory");
            env.put(Context.PROVIDER_URL, "ldap://ldap.ues.edu.sv:389/ou=usuarios,dc=ues,dc=edu,dc=sv???(objectClass=inetOrgPerson)");
