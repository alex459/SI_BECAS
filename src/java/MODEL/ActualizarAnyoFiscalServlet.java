 ...
 * @author adminPC
 */
@WebServlet(name = "ActualizarAnyoFiscalServlet", urlPatterns = {"/ActualizarAnyoFiscalServlet"})
@MultipartConfig(maxFileSize = 16177215)
public class ActualizarAnyoFiscalServlet extends HttpServlet {
        ...
        try {
            ...
            switch (accCarta) {
                ...
                case "eliminar":
                    ...
                    id_documento = documentoDao.ExisteDocumento(idExpediente, 135);
                    if (id_documento != 0) {
                        //eliminar
            ...
            if(accCarta.equals("ninguna")){
                ...
                id_documento = documentoDao.ExisteDocumento(idExpediente, 136);
                documento = documentoDao.obtenerInformacionDocumentoPorId(id_documento);
