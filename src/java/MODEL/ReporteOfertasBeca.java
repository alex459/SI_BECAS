 ...
 * @author next
 */
@WebServlet("/ReporteOfertasBecaServlet")
public class ReporteOfertasBeca extends HttpServlet {
          ...
          parametersMap.put("condicion", condicion);
            ...
            /*
                ...
                */
                ...
                byte[] bytes = JasperRunManager.runReportToPdf(path + "/111_Reporte_Oferta_Becas.jasper", parametersMap, conexionBD.conn);
                conexionBD.cerrarConexion();
                response.setContentType("application/pdf");
                response.setContentLength(bytes.length);
                ServletOutputStream outputstream = response.getOutputStream();
