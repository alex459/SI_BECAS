    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        if(ingresarDocumento== true){
            ...
            Utilidades.mostrarMensaje(response, 1, "Exito", "Se modifico el documento de Permiso Inicial correctamente.");
        }
        else
            Utilidades.mostrarMensaje(response, 2, "Error", "No se pudo modifico el documento de la solicitud del Acuerdo de Permiso Inicial.");
