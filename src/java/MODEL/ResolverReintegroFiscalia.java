 ...
 * @author adminPC
 */
@WebServlet(name = "ResolverReintegroFiscalia", urlPatterns = {"/ResolverReintegroFiscalia"})
@MultipartConfig(maxFileSize = 16177215)
public class ResolverReintegroFiscalia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer id_documento = documentoDao.ExisteDocumento(idExpediente, 159);
            ...
            switch (resolucion) {
                ...
                case "DENEGADO":
                    ...
                    expDao.actualizarExpediente(expediente);
                    break;
                    //SE DEBE PREGUNTAR SI AL SUSPENDER BECARIO SE ENVIA ALGUN DOCUMENTO A FISCALIA
                /*case "CORRECCION":
