...
public class DocumentoDAO extends ConexionBD{
    ...
    public Integer ExisteDocumento(Integer idExpediente, Integer idTipo) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO FROM DOCUMENTO D where ID_EXPEDIENTE = " + idExpediente +" AND ID_TIPO_DOCUMENTO= " + idTipo +" GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            this.cerrarConexion();
    ...
    public ArrayList<Documento> consultarConsejoBecas2(int exp) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE E.ID_EXPEDIENTE='" + exp + "' AND TD.ID_TIPO_DOCUMENTO IN (101,103, 104, 123, 124, 126,128,129,160,161 ) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    //obtener documentos de consejo de becas   2. ACUERDO DE AUTORIZACION INICIAL
    public ArrayList<Documento> consultarConsejoSuperiorUniversitario26(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
    ...
    public ArrayList<Documento> consultarConsejoBecas5(int exp) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE E.ID_EXPEDIENTE='" + exp + "' AND TD.ID_TIPO_DOCUMENTO IN (103,105,119,120,121,122, 123,124,125,126,127,128,129,130) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    //obtener documentos de consejo de becas   15. ACUERDO DE AÑO FISCAL CONSEJO DE BECAS
    public ArrayList<Documento> consultarConsejoBecas25(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
    ...
    public ArrayList<Documento> consultarFiscaliaContratoBeca(int exp) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE E.ID_EXPEDIENTE = " + exp + " AND D.ESTADO_DOCUMENTO IN ('APROBADO','INGRESADO') GROUP BY  D.ID_TIPO_DOCUMENTO" ;
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
...
//obtener documentos de expediente   8. CONTRATO DE BECA
    public ArrayList<Documento> consultarFiscaliaReintegroBeca(int exp) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O,D.ESTADO_DOCUMENTO, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE E.ID_EXPEDIENTE = " + exp + " AND D.ESTADO_DOCUMENTO NOT IN ('PENDIENTE', 'CORRECCION', 'EN ESPERA', 'CANCELADO') GROUP BY  D.ID_TIPO_DOCUMENTO" ;
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    public ArrayList<Documento> consultarSolicitudesBecario(int idExpediente) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT D.ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO, D.ESTADO_DOCUMENTO FROM DOCUMENTO D INNER JOIN TIPO_DOCUMENTO TD ON D.ID_TIPO_DOCUMENTO = TD.ID_TIPO_DOCUMENTO WHERE D.ID_TIPO_DOCUMENTO IN (136,140,151,155,157) AND D.ID_EXPEDIENTE = " +idExpediente ;
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    public ArrayList<Documento> documentosAutorizacionInicial(int exp) {
        ...
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE D.ID_EXPEDIENTE='" + exp + "' AND D.ID_TIPO_DOCUMENTO IN (104,123, 124, 126,128,129,160,161) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    public ArrayList<Documento> DocumentosInicioServicio(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
        
        this.abrirConexion();
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE D.ID_EXPEDIENTE='" + exp + "' AND D.ID_TIPO_DOCUMENTO IN (147,148,149,150) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    public ArrayList<Documento> DocumentosGestionContractual(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
        
        this.abrirConexion();
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE D.ID_EXPEDIENTE='" + exp + "' AND D.ID_TIPO_DOCUMENTO IN (153,154) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    public ArrayList<Documento> DocumentosGestionLiberacion(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
        
        this.abrirConexion();
        try {
            stmt = conn.createStatement();
            String sql = "SELECT IFNULL(MAX(D.ID_DOCUMENTO), 0) AS ID_DOCUMENTO, D.ID_TIPO_DOCUMENTO, D.OBSERVACION_O, TD.TIPO_DOCUMENTO FROM TIPO_DOCUMENTO TD JOIN DOCUMENTO D ON TD.ID_TIPO_DOCUMENTO = D.ID_TIPO_DOCUMENTO JOIN EXPEDIENTE E ON D.ID_EXPEDIENTE = E.ID_EXPEDIENTE WHERE D.ID_EXPEDIENTE='" + exp + "' AND D.ID_TIPO_DOCUMENTO IN (156) GROUP BY  D.ID_TIPO_DOCUMENTO";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                Documento temp = new Documento();
                TipoDocumento temp2 = new TipoDocumento();                
    ...
    //Cancela todos los documentos que estan en espera de correccion y revision
    public boolean CancelarDocumentos(int idExpediente) {
        boolean exito = false;
        
        this.abrirConexion();
        try {
            String sql = "UPDATE DOCUMENTO SET ESTADO_DOCUMENTO= 'CANCELADO' WHERE ESTADO_DOCUMENTO IN ('EN ESPERA', 'REVISION','CORRECCION') AND ID_EXPEDIENTE=?";
            PreparedStatement statement = conn.prepareStatement(sql);
    ...
    public ArrayList<Documento> DocumentosAcuerdoFiscal(int exp) {
        ArrayList<Documento> lista = new ArrayList<Documento>();
